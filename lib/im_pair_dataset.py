...
class ImagePairDataset(Dataset):
    ...
    def __init__(self, dataset_csv_path, dataset_csv_file, dataset_image_path, dataset_size=0,output_size=(240,240),transform=None,random_crop=False,random_affine=False):
        self.random_crop=random_crop
        if random_affine:
            self.random_affine=torchvision.transforms.RandomAffine(40, translate=None, scale=(1,1.5), shear=40, resample=PIL.Image.BILINEAR)
        else:
    ...
    def get_image(self,img_name_list,idx,flip,affine=False):
